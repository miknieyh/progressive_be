...
public class PostsSaveRequestDto {
    ...
    @Builder
    public PostsSaveRequestDto(String num,String project,String item,String jiraLink,String department,String productOwner,String productManager, Progress progress,
